    ...
    if CheckConstructivenessOfCategory( C, "IsEquippedWithHomomorphismStructure" ) = [ ] then
        ...
        AddHomomorphismStructureOnObjects( IC,
          function( object1, object2 )
            ...
            hom := HomomorphismStructureOnObjects( ActiveCell( object1 ), ActiveCell( object2 ) );
            
            return Intrinsify( RangeCategoryOfHomomorphismStructure( CapCategory( object1 ) ), hom );
        ...
        AddHomomorphismStructureOnMorphismsWithGivenObjects( IC,
          function( source, alpha, beta, range )
            ...
            hom := HomomorphismStructureOnMorphismsWithGivenObjects( CertainCell( source, s ), ActiveCell( alpha ), ActiveCell( beta ), CertainCell( range, t ) );
        ...
        AddInterpretMorphismAsMorphismFromDistinguishedObjectToHomomorphismStructure( IC,
          function( morphism )
            ...
            mor := InterpretMorphismAsMorphismFromDistinguishedObjectToHomomorphismStructure( ActiveCell( morphism ) );
            
            D := DistinguishedObjectOfHomomorphismStructure( CapCategory( morphism ) );
